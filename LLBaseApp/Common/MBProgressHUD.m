...
//回调    
- (void)hideAnimated:(BOOL)animated afterDelay:(NSTimeInterval)delay complate:(hudHideBlock)block{
    NSMutableDictionary *dict = [[NSMutableDictionary alloc] init];
    [dict setObject:[NSNumber numberWithBool:animated] forKey:@"ani"];
    [dict setObject:block forKey:@"block"];
    [self performSelector:@selector(hideDelayedBlock:) withObject:dict afterDelay:delay];
}
...
- (void)hideDelayedBlock:(NSMutableDictionary *)dict{
    NSNumber *animated = dict[@"ani"];
    [self hideAnimated:[animated boolValue]];
    hudHideBlock block = dict[@"block"];
    block();
